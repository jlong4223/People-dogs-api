...
class LedgersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ledger" do
    assert_difference('Ledger.count') do
      post ledgers_url, params: { ledger: { dog_id: @ledger.dog_id, person_id: @ledger.person_id, qty: @ledger.qty } }, as: :json
    end
  ...
  test "should update ledger" do
    patch ledger_url(@ledger), params: { ledger: { dog_id: @ledger.dog_id, person_id: @ledger.person_id, qty: @ledger.qty } }, as: :json
    assert_response 200
  end
