...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { breed: @dog.breed, name: @dog.name, sex: @dog.sex, weight: @dog.weight } }, as: :json
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { breed: @dog.breed, name: @dog.name, sex: @dog.sex, weight: @dog.weight } }, as: :json
    assert_response 200
  end
